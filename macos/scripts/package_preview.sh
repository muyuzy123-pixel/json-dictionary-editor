...
install -m 755 "$UNSIGNED_APP/Contents/MacOS/JSONDictionaryEditor" "$STAGE/$APP_NAME/Contents/MacOS/JSONDictionaryEditor"
install -m 644 "$UNSIGNED_APP/Contents/Info.plist" "$STAGE/$APP_NAME/Contents/Info.plist"
install -m 644 "$UNSIGNED_APP/Contents/Resources/AppIcon.icns" "$STAGE/$APP_NAME/Contents/Resources/AppIcon.icns"
